...
export const Logo = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 153 26" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const LogoMobile = (props: SVGProps<SVGSVGElement>) => (
...
export const VerticalEllipsis = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 5 20" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g fillRule="evenodd">
...
export const ChevronUp = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 10 7" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const EmptyBoardIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    viewBox="0 0 32 32"
    ...
    <g id="page_x2C__document_x2C__emoji_x2C__No_results_x2C__empty_page">
      <g id="XMLID_1521_">
        <path
          ...
          fill="#263238"
          className="fill-secondary-foreground group-hover:fill-accent"
          id="XMLID_1887_"
        />
      ...
      <g id="XMLID_1337_">
        <g id="XMLID_4010_">
          <polyline
            ...
            stroke="#455A64"
            className="stroke-secondary-foreground group-hover:stroke-accent"
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeMiterlimit="10"
          />
