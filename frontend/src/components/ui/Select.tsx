...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <ChevronUp className="w-3 [&_path]:stroke-accent group-hover:[&_path]:stroke-accent-hover" />
  </SelectPrimitive.ScrollUpButton>
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ...
    {...props}
  >
    <ChevronDown className="w-3 [&_path]:stroke-accent group-hover:[&_path]:stroke-accent-hover" />
  </SelectPrimitive.ScrollDownButton>
));
